...
One thing that annoys me about the crypto space is that someone let the engineers do the marketing for it.

Invariably, this leads to stupidly complex explanations of things that are often quite simple.
...
All they are is the transformation of a principle obvious with physical assets, brought to the digital space.

**So if any of your friends, your family, or your colleagues ask what an NFT is, say this analogy:**
...
In that way, everyone would be able to see what you uploaded, when, and the fact that _you_ uploaded it. Therefore meaning anyone would be able
...
Because say one day Greg comes along and wants to own that image, all that has been done to transfer that ownership is have you post on
that same bulletin board: "I'm transfering ownership to Greg".

And forever from that point, everyone will be able to see that you uploaded it first, and then sent it to Greg later on (hopefully for some profit).
...
Note for the technical people who already know what an NFT and how they work: please remember this is a simplification for the purpose
